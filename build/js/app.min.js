...
function Ajax(params,url,callbackFunction){this.params=params,this.url=url,this.callback=callbackFunction}Ajax.prototype.request=function(){$.ajax({contentType:"application/json; charset=utf-8",dataType:"json",type:"post",data:this.params,success:this.callback,error:this.callback})};
$(document).ready(function(){});
$(document).ready(function(){function printTest(){console.log("Hello")}var ajaxTest=new Ajax("google.com",{},printTest);console.log(ajaxTest),ajaxTest.request()});